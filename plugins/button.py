...
def start_button(client):
    ...
    if FORCE_SUB_CHANNEL and not FORCE_SUB_GROUP:
        buttons = [
            [
                InlineKeyboardButton(text="ɴᴇᴛꜰʟɪx", url=client.invitelink),
            ],
            [
                InlineKeyboardButton(text="ʜᴇʟᴘ", callback_data="help"),
                InlineKeyboardButton(text="ᴄʟᴏꜱᴇ", callback_data="close"),
    ...
    if FORCE_SUB_CHANNEL and FORCE_SUB_GROUP:
        buttons = [
            ...
            [
                ...
                InlineKeyboardButton(text="ꜱᴇʀɪᴇꜱ ᴄʜᴀɴɴᴇʟ", url=client.invitelink2),
            ],
            [InlineKeyboardButton(text="ᴄʟᴏꜱᴇ", callback_data="close")],
        ]
        return buttons
...
def fsub_button(client, message):
    ...
    if FORCE_SUB_CHANNEL and FORCE_SUB_GROUP:
        buttons = [
            [
                InlineKeyboardButton(text="ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ 1", url="https://t.me/+L3DSvbABRjk1MjU1"),
